    ...
    <form onSubmit={handleSubmit} className="rounded-[28px] bg-white p-5 shadow-soft sm:p-7">
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <label className="block">
          ...
          <select
            ...
            className="mt-2 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold outline-none transition focus:border-demo-blue focus:ring-4 focus:ring-demo-blue/10"
          >
      ...
      <label className="mt-4 block">
        ...
        <textarea
          ...
          className="mt-2 w-full resize-none rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none transition focus:border-demo-blue focus:ring-4 focus:ring-demo-blue/10"
        />
      </label>
      {feedback && (
      ...
      <button
        ...
        className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-full bg-demo-blue px-6 py-3 text-sm font-extrabold text-white shadow-lg shadow-demo-blue/20 transition hover:bg-demo-blueDark disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
      >
        <Send size={18} />
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="mt-2 w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none transition focus:border-demo-blue focus:ring-4 focus:ring-demo-blue/10"
      />
    </label>
  );
}
